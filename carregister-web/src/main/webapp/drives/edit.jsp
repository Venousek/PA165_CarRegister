<%-- 
    Document   : edit
    Created on : Dec 15, 2016, 10:27:10 PM
    Author     : ferko
--%>
...
<s:message code="drives.edit" var="title"/>
<my:pagetemplate title="${title}">
<jsp:attribute name="body">
    <form:form method="post" action="${pageContext.request.contextPath}/drives/editItem"
               modelAttribute="drive" cssClass="form-horizontal">
          <form:input type="hidden" path="id" />
      
        <div class="form-group">
          <form:label path="user.id" cssClass="col-sm-2 control-label"><fmt:message key="general.user"/></form:label>
            <div class="col-sm-4">
                ...
                <p class="help-block"><form:errors path="user.id" cssClass="help-block"/></p>
            </div> 
        </div>
       <div class="form-group">
